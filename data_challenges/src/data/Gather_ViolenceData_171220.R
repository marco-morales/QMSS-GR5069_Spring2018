...
source("src/data/DefineFunctions.R")   # loads custom-made functions  
...
path <- paste0(here::here(), "/data_challenges")
...
outFileName1 <- "data//processed/AllViolenceData_171220.csv" # output file name
