...
AllData <- read.csv("C://Users//206455361//Dropbox (Personal)//GR5069_Spring2018//GR5069_Spring2018//data_challenges//data//processed//AllViolenceData_171220.csv")
```
...
```{r}
fit <- glm(formula = perfect_lethality ~ total_people_dead+ total_people_wounded + long_guns_seized+ small_arms_seized+ cartridge_sezied+ clips_seized+ afi+ army+ navy+ federal_police+ state_police, family = binomial(link = "logit"),
data = AllData)
